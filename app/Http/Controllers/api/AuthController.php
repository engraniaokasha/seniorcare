    ...
    public function addpatient(Request $request) {    
     ...
     public function getemergency(Request $request)
      { 
         ...
         $emergency = \DB::table('emergency')->find($id);
            return response()->json(['success' => $emergency->type], $this->successStatus); 
      ...
      public function getpatients() {
         ...
         return response()->json(['success' => $allpatients], $this->successStatus); 
         }
}